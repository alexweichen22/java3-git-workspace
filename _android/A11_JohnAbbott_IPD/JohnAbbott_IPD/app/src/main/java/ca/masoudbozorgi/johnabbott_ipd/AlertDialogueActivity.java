...
public class AlertDialogueActivity extends AppCompatActivity
    ...
    public void showAlertDialog2(View view) {
        ...
        builder.setTitle("AlertDialog\njust a question for demo")
                ...
                .setPositiveButton("Yes",
                        (dialogInterface, i) -> Toast.makeText(AlertDialogueActivity.this,
                        "File Deleted!",
                        Toast.LENGTH_SHORT).show())
    ...
    public void showAlertDialog4(View view) {
        ...
        builder.setTitle("")
                .setCancelable(true)
                .setMultiChoiceItems(
                        new String[]{"item0", "item1", "item2", "item3", "item4", "item5"}, // Multi Choice
                        new boolean[]{false, true, false, true, true, false},               // Define default state
                        new DialogInterface.OnMultiChoiceClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface,
                                                int i,
                                                boolean b) {     // i for index, b for boolean state
                                Toast.makeText(AlertDialogueActivity.this,
                                        "item" + i + " : " + b,
                                        Toast.LENGTH_SHORT).show();
                            }
    ...
    // This method is called by button onClick in Layout
