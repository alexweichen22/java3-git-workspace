...
// register event handlers
        ...
        // key step "addActionLister" to the textField to build relationship between the "action" with the "textFieldx"
        // to force the "textfield" and "the listener" listen to the same "method"######################
